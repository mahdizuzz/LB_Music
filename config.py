...
OWNER_ID = int(getenv("OWNER_ID", "6067410368"))
...
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/musicpl11")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/de59f63f36f84d46867b2.mp4"
)
PING_IMG_URL = getenv(
